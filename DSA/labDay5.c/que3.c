...
void add_198(struct node_198 *start1_198, struct node_198 *start2_198, struct node_198 **start3_198)
{
    struct node_198 *temp1_198 = start1_198;
    struct node_198 *temp2_198 = start2_198;
    while (temp1_198 != NULL && temp2_198 != NULL)
    {
        if (temp1_198->expo > temp2_198->expo)
        {
            create_198(start3_198, temp1_198->coeff, temp1_198->expo);
            temp1_198 = temp1_198->next;
        }
        else if (temp1_198->expo < temp2_198->expo)
        {
            create_198(start3_198, temp2_198->coeff, temp2_198->expo);
            temp2_198 = temp2_198->next;
        }
        else
        {
            create_198(start3_198, temp1_198->coeff + temp2_198->coeff, temp1_198->coeff);
            temp1_198 = temp1_198->next;
            temp2_198 = temp2_198->next;
        }
    }
...
int main()
{
    ...
    add_198(start1_198, start2_198, &head3_198);
