...
void create_node(struct student *value)
{
    node *temp;
...
int main()
{
    ...
    main:
        ...
        cout << endl
             << "5. Search";
        cout << endl
             << "6.Delete and store all students whose CGPA<6.0";
        cout << endl
             << "Chose option : ";
        cin >> choice;
        switch (choice)
        ...
        case 1:
        {
            ...
            smain:
                ...
                case 4:
                {
                    ...
                    cin >> name;
                    if (search(name))
                        cout << "Yes the student is found\n";
                    else
                        cout << "No the student is not found\n";
        ...
        case 6:
        {
            ...
            cout << endl
                 << "Storing students details whose cgpa is less than 6.0: ";
            cgpa_search();
            break;
        }
