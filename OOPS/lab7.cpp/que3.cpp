...
public:
    test_198(string n, int a, int r, int m[3]) : student_198(n, a, r)
    {
        for (int i = 0; i < 3; i++)
        {
            marks[i] = m[i];
...
public:
    activity_198(string n, int a, int r, int ac[2]) : student_198(n, a, r)
    {
        for (int i = 0; i < 2; i++)
        {
            act[i] = ac[i];
...
class result : public test_198, public activity_198
{
    char grade;
    float percent;
    float totalMarks;
...
public:
    result(string n, int a, int r, int m[3], int ac[2]) : student_198(n, a, r), test_198(n, a, r, m), activity_198(n, a, r, ac)
    {
    }
    void calculate()
    {
    ...
    void display_198()
    {
        ...
        cout << "Grade of the student8 is : " << grade << endl;
    }
};
...
int main()
{
    ...
    cout << "Enter name,age, rollnumbers of student_198 :\n";
    string n;
    int a, r;
    getline(cin, n);
    cin >> a >> r;
